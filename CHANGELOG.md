...
- Fix marketplace.json `source` field: `"."` → `"./"` (Claude Code plugin validation requires `./` prefix)
- Enforce default 1200 DPI: updated all tool descriptions and Skills to prevent Claude from auto-lowering DPI
